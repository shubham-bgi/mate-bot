...
module.exports = {
    ...
    console.log(args);
    if (!args[0] || args[0].toLowerCase() == 'main' || args[0].toLowerCase() == 'mini' || args[0].toLowerCase() == 'feeder' || args[0].toLowerCase() == 'frnds' || args[0].toLowerCase() == 'allies' || args[0].toLowerCase() == 'sister' || args[0].toLowerCase() == 'no') {
